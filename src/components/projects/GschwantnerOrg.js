...
export default function GschwantnerOrgTeaser(props) {
  return (
    <PageSection as="article" bg="#CA336C" color="#fff" {...props}>
      ...
      >
        <P>
          For my personal website, I strived for a playful, bold and bright
          style. I want this site to be a place where I can equally experiment,
          showcase what I do and publish thoughts and articles I care about.
        </P>
        <P>
